...
export default function Navbar() {
  ...
  return (
    <>
      <motion.div 
        className="fixed top-0 left-0 right-0 h-[2px] bg-gold origin-left z-[1000]" 
        style={{ scaleX }}
      />
      <div className="fixed top-4 sm:top-8 left-0 w-full z-[100] flex justify-center px-4 sm:px-6">
        <motion.nav
          ...
          transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] as any }} // eslint-disable-line @typescript-eslint/no-explicit-any
